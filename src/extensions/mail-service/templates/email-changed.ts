export default (message: any) => {
  return `
                ...
                <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="email-masthead">
                      <a href="https://masteringbackend.com?source=email_changed_email" class="f-fallback email-masthead_name">
    ...
    message.email
  }. If you didn't request this change,  <a href="mailto:support@masteringbackend.com">talk to us</a> to revert it.
